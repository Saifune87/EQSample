...
{
    /// <summary>
    ///To implement the interface of IMessageTypehandler that utilizes the arguments for home delivery order confirmation, Right click and impliment the interface.  
    /// </summary>
    public sealed class HDOrderConfirmationMessageTypeHandler : IMessageTypeHandler
    {
        /// <summary>
        ...
        private object ParseMessageArguments(Message message)
        {
            var result = new
            {
                OrderHeaderID = message.Arguments
            };
