...
{            
    /// <summary>
    ///To implement the interface of IMessageTypehandler that utilizes the arguments for size notification, Right click and impliment the interface.  
    /// </summary>
    public sealed class SizeNotificationMessageTypeHandler : MessageTypeHandlerBase<SizeNotificationMessageArgs>, IMessageTypeHandler
    {
        /// <summary>
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        protected override SizeNotificationMessageArgs ParseMessageArguments(Message message)
        {
            XDocument doc = XDocument.Parse(message.Arguments);

            var root = doc.Root; 

            var result = new SizeNotificationMessageArgs(); 
        ...
        /// <summary>
        /// mapper method for size notification. Since there is only 1 item return each time,
        /// no loop required for this messageType
        /// </summary>
        ...
        private ApiSubmission Map(MessageTypeModelWrapper model, Message message)
        {
            ...
            RecepientTransRecord.TableName = "";
        ...
        /// <summary>
        /// private method for gathering data for size notification.
        /// </summary>
        /// <param name="args"></param>
        /// <returns></returns>
        private MessageTypeModelWrapper GetData(SizeNotificationMessageArgs args)
        {
