...
namespace EQService.MessageTypeHandlers
{
    ...
    /// 
    /// </summary>
    public sealed class ShippingNotificationMessageTypeHandler : IMessageTypeHandler
    {
        /// <summary>
        ...
        private object ParseMessageArguments(Message message)
        {
            ...
            message.OrderNumber = root.Element("OrderNumber").Value;
        ...
        /// <summary>
        /// Private method for mapping the shipment model back to the Handeling method for Shipment Notifican. 
        /// </summary>
        ...
        private ApiSubmission Map(MessageTypeModelWrapper model, Message message)
        {
            ...
            rtrecord.Fields.Add(new ApiSubmissionRecordField { FieldName = "category_url", Value = rt.HomeURL });
            ...
            rtrecord.Fields.Add(new ApiSubmissionRecordField { FieldName = "trackingnumber", Value = rt.TrackingNumber });
            rtrecord.Fields.Add(new ApiSubmissionRecordField { FieldName = "trackingurl", Value = rt.TrackingURL });
        ...
        /// <summary>
        /// Private model for getting the shipment data for Shipment Notification.
        /// </summary>
