...
{
    /// <summary>
    ///To implement the interface of IMessageTypehandler that utilizes the arguments for home delivery shipment notification, Right click and impliment the interface.  
    /// </summary>
    public sealed class HDShippingNotificationMessageTypeHandler : IMessageTypeHandler
    {
        /// <summary>
